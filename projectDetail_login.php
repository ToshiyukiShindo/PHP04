...
<section class="leftpage">
    ...
    <div class="summary">
        ...
        <hr>
        <h3>目標・ゴール：<br><?= $resultDis[0]['goal'] ?></h3>
        <hr>
        <h3>その他：<br><?= $resultDis[0]['otherdescription'] ?></h3>
        <hr>
    </div>
</section>
<section class="rightpage">
    ...
    <div class="abstraction">
        <h2>現在総計：<?= $resultDis[0]['sum(support_amount)'] ?>
        (<?= floor($resultDis[0]['sum(support_amount)']/$resultDis[0]['target']*100)?>%)</h2>
        <hr>
        <h2>サポート回数：<?= $resultDis[0]['count(user_email)'] ?></h2>
        <hr>
        <div class="likebtn">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-body">
                ...
                <div>
                    <p>概要：</p><textarea value="<?=$record['description']?>" rows="2" class="card-text"  style="border:none; width: 30vw;background-color:white;" disabled></textarea>
                </div>
                <input type="text" value="<?=$useremail?>" name="useremail2" class="card-text"  style="border:none; background-color: rgb(248,250,252);width: 20vw; display:none;"> </input>
                <input type="text" value="<?=$record['support_title']?>" name="s_title" class="card-text"  style="border:none; background-color: rgb(248,250,252);width: 20vw; display:none;"> </input>
                <input type="number" value="<?=$record['support_amount']?>" name="s_amount" class="card-text"  style="border:none; background-color: rgb(248,250,252);width: 20vw; display:none;"> </input>
                <input type="number" value="<?=$record['p_support_id']?>"  name="psid" class="card-text"  style="border:none; background-color: rgb(248,250,252);width: 20vw; display:none;"> </input>
                <input type="number" value="<?=$record['project_id']?>" name="pid" class="card-text"  style="border:none; background-color: rgb(248,250,252);width: 20vw; display:none;"> </input>
                <div style="margin-top: 20px;">
                    <input type="submit" class="btn btn-danger" value="Support!"></input>
                </div>
            </div>
        </div>
    </div>
