...
try{
    ...
    $sqlusup = "INSERT INTO `user_supports`(`id`, `user_email`, `project_id`, `p_support_id`, `support_title`, `support_amount`, `created_at`) VALUES (NULL,'$usemail2','$uspid2','$uspsid2','$ustitle2','$usamount2',sysdate())";
